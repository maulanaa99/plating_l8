...
<head>
    ...
    <title>PLATING | PT. XYZ | @yield('title')</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-info elevation-4">
            ...
            <a href="/" class="brand-link">
                <img src="{{ asset('assets/dist/img/credit/american-express.png') }}" alt="AdminLTE Logo"
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('kensa.utama') }}" class="nav-link">
                                        <i class="nav-icon far fa-circle nav-icon"></i>
                                        <p>Menu Utama</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('kensa') }}" class="nav-link">
                                        <i class="nav-icon far fa-circle nav-icon"></i>
                                        <p>Kensa</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('kensa.tambah') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Input Stock</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('kensa.printKanban') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Print Kanban</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('kensa.pengiriman') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Pengiriman</p>
                                    </a>
                                </li>
